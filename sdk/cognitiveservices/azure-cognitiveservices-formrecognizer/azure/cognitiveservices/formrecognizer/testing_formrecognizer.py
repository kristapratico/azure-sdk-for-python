...
def testing_receipt():
    ...
    # import json
    # result = AnalyzeOperationResult.deserialize(json.loads(sample))
    # print(result)
    client = FormRecognizerClient(endpoint=endpoint, credentials=key, headers={"Ocp-Apim-Subscription-Key": key})
