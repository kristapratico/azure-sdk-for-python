...
from ._projects import ConversationAnalysisProjectsClient as GeneratedConversationAnalysisProjectsClient
...
class ConversationAnalysisProjectsClient(GeneratedConversationAnalysisProjectsClient):
    ...
    def begin_import_project(
        ...
        return super().begin_import_project(project_name, body, exported_project_format=exported_project_format, **kwargs)
