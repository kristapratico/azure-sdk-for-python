...
class MetadataRolesOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.purview.administration.metadatapolicies.aio.PurviewMetadataPoliciesClient`'s
...
class MetadataPolicyOperations:
    ...
    @distributed_trace
    def list_all(self, *, collection_name: Optional[str] = None, **kwargs: Any) -> AsyncIterable[JSON]:
    ...
    async def update(self, policy_id: str, body: Optional[Union[JSON, IO]] = None, **kwargs: Any) -> JSON:
        """Updates a metadata policy.
    ...
    @distributed_trace_async
    async def get(self, policy_id: str, **kwargs: Any) -> JSON:
