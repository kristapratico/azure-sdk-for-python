...
def build_open_ai_get_embeddings_request(
    deployment_id: str,
    **kwargs: Any
) -> HttpRequest:
...
def build_open_ai_get_completions_request(
    deployment_id: str,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class OpenAIClientOperationsMixin( 
    ...
    def begin__begin_azure_batch_image_generation(  # pylint: disable=protected-access,name-too-long
        self,
