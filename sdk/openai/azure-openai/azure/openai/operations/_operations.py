...
def build_completions_create_request(deployment_id: str, **kwargs: Any) -> HttpRequest:
...
def build_images_generate_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ImagesOperations:
    ...
    def __generate_initial(self, body: Union[_models._models.ImageGenerationOptions, JSON, IO], **kwargs: Any) -> JSON:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    def begin__generate(  # pylint: disable=protected-access
        ...
        if cont_token is None:
            raw_result = self.__generate_initial(
