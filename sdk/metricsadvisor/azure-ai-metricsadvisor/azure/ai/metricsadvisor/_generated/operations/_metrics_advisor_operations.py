...
def build_get_alerts_by_anomaly_alerting_configuration_next_request(
    next_link,  # type: str
    **kwargs  # type: Any
):
    # type: (...) -> HttpRequest
    ...
    accept = "application/json"
    # Construct URL
    url = kwargs.pop("template_url", '/{nextLink}')
    path_format_arguments = {
...
def build_get_anomalies_by_anomaly_detection_configuration_next_request(
    next_link,  # type: str
    **kwargs  # type: Any
):
    # type: (...) -> HttpRequest
...
def build_get_dimension_of_anomalies_by_anomaly_detection_configuration_next_request(
    next_link,  # type: str
    **kwargs  # type: Any
):
    # type: (...) -> HttpRequest
...
def build_list_metric_feedbacks_next_request(
    next_link,  # type: str
    **kwargs  # type: Any
):
    # type: (...) -> HttpRequest
...
def build_get_data_feed_ingestion_status_next_request(
    next_link,  # type: str
    **kwargs  # type: Any
):
    # type: (...) -> HttpRequest
...
def build_get_metric_series_next_request(
    next_link,  # type: str
    **kwargs  # type: Any
):
    # type: (...) -> HttpRequest
...
def build_get_metric_dimension_next_request(
    next_link,  # type: str
    **kwargs  # type: Any
):
    # type: (...) -> HttpRequest
...
def build_get_enrichment_status_by_metric_next_request(
    next_link,  # type: str
    **kwargs  # type: Any
):
    # type: (...) -> HttpRequest
...
class MetricsAdvisorOperationsMixin(object):
    ...
    def get_alerts_by_anomaly_alerting_configuration(
        ...
        **kwargs  # type: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.ai.metricsadvisor._generated.models.AlertResultList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def get_anomalies_from_alert_by_anomaly_alerting_configuration(
        ...
        **kwargs  # type: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.ai.metricsadvisor._generated.models.AnomalyResultList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_incidents_from_alert_by_anomaly_alerting_configuration(
        ...
        **kwargs  # type: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.ai.metricsadvisor._generated.models.IncidentResultList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_anomaly_alerting_configurations_by_anomaly_detection_configuration(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either AnomalyAlertingConfigurationList or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.ai.metricsadvisor._generated.models.AnomalyAlertingConfigurationList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_dimension_of_anomalies_by_anomaly_detection_configuration(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either AnomalyDimensionList or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.ai.metricsadvisor._generated.models.AnomalyDimensionList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def list_credentials(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either DataSourceCredentialList or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.ai.metricsadvisor._generated.models.DataSourceCredentialList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_data_feeds(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.ai.metricsadvisor._generated.models.DataFeedList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_metric_feedbacks(
        ...
        **kwargs  # type: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.ai.metricsadvisor._generated.models.MetricFeedbackList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def list_hooks(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.ai.metricsadvisor._generated.models.HookList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_data_feed_ingestion_status(
        ...
        **kwargs  # type: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.ai.metricsadvisor._generated.models.IngestionStatusList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def get_metric_series(
        ...
        **kwargs  # type: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.ai.metricsadvisor._generated.models.MetricSeriesList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def get_metric_dimension(
        ...
        **kwargs  # type: Any
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.ai.metricsadvisor._generated.models.MetricDimensionList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
    ...
    def get_anomaly_detection_configurations_by_metric(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either AnomalyDetectionConfigurationList or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.ai.metricsadvisor._generated.models.AnomalyDetectionConfigurationList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_enrichment_status_by_metric(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of either EnrichmentStatusList or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.ai.metricsadvisor._generated.models.EnrichmentStatusList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        content_type = kwargs.pop('content_type', "application/json")  # type: Optional[str]
