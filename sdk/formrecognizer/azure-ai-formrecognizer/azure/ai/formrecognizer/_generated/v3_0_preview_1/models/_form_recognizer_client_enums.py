...
class ApiVersion(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
    ...
    TWO_THOUSAND_TWENTY_ONE07_30_PREVIEW = "2021-07-30-preview"

class ContentSourceKind(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
    """Source types.
    """
...
class DocumentModelBuildTechnique(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
    ...
    FIXED_TEMPLATE2021_07_30 = "fixedTemplate-2021-07-30"
...
class FieldTypeSchemaType(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
    """Field type.
    """
