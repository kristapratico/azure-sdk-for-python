...
def sample_translation():
    ...
    print("Job status: {}".format(poller.details.status))
    print("Job created on: {}".format(poller.details.created_on))
    print("Job last updated on: {}".format(poller.details.last_updated_on))
