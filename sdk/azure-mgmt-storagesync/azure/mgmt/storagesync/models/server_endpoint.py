...
class ServerEndpoint(ProxyResource):
    ...
    :ivar health: Overall health state of the server endpoint. Possible values
     include: 'Healthy', 'Error', 'AppearsOffline'
    :vartype health: str or ~azure.mgmt.storagesync.models.enum
    :ivar last_health_update_timestamp: Timestamp of when the 'health'
     property was last updated.
    :vartype last_health_update_timestamp: datetime
    :ivar cloud_tiering_status: Server Endpoint cloud tiering status
    :vartype cloud_tiering_status:
     ~azure.mgmt.storagesync.models.ServerEndpointCloudTieringStatus
    :ivar recall_status: Server Endpoint recall status
    ...
    _validation = {
        ...
        'last_health_update_timestamp': {'readonly': True},
    ...
    _attribute_map = {
        ...
        'last_health_update_timestamp': {'key': 'properties.lastHealthUpdateTimestamp', 'type': 'iso-8601'},
    ...
    def __init__(self, **kwargs):
        ...
        self.health = None
        self.last_health_update_timestamp = None
