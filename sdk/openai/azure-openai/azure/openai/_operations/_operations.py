...
def build_open_ai_get_chat_completions_request(deployment_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_open_ai_get_chat_completions_with_azure_extensions_request(deployment_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_open_ai_get_azure_batch_image_generation_operation_status_request(
...
def build_open_ai_begin_azure_batch_image_generation_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class OpenAIClientOperationsMixin(OpenAIClientMixinABC):
    ...
    def _get_chat_completions_with_azure_extensions(
        self,
        deployment_id: str,
        body: _models.ChatCompletionsOptions,
        *,
    ...
    def __get_azure_batch_image_generation_operation_status_initial(self, operation_id: str, **kwargs: Any) -> JSON:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    def begin__get_azure_batch_image_generation_operation_status(  # pylint: disable=protected-access
    ...
    def __begin_azure_batch_image_generation_initial(
    ...
    def begin__begin_azure_batch_image_generation(  # pylint: disable=protected-access
