...
try:
    ...
    from ._models_py3 import CustomMultiClassificationLROTask
    ...
    from ._models_py3 import CustomSingleClassificationLROTask
    ...
    from ._models import CustomMultiClassificationLROTask  # type: ignore
    ...
    from ._models import CustomSingleClassificationLROTask  # type: ignore
