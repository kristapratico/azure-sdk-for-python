...
class AccountsOperations:
    ...
    async def get_account_properties(self, **kwargs: Any) -> JSON:
        """Get an account.
    ...
    @distributed_trace_async
    async def update_account_properties(self, account_update_parameters: Union[JSON, IO], **kwargs: Any) -> JSON:
        """Updates an account.
    ...
    @distributed_trace_async
    async def get_access_keys(self, **kwargs: Any) -> JSON:
    ...
    @overload
    async def regenerate_access_key(
        self, key_options: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> JSON:
        """Regenerate the authorization keys associated with this data catalog.
    ...
    @distributed_trace_async
    async def regenerate_access_key(self, key_options: Union[JSON, IO], **kwargs: Any) -> JSON:
        """Regenerate the authorization keys associated with this data catalog.
...
class CollectionsOperations:
    ...
    @distributed_trace_async
    async def get_collection(self, collection_name: str, **kwargs: Any) -> JSON:
        """Get a collection.
    ...
    @distributed_trace_async
    async def create_or_update_collection(
        self, collection_name: str, collection: Union[JSON, IO], **kwargs: Any
    ) -> JSON:
        """Creates or updates a collection entity.
    ...
    @distributed_trace
    def list_collections(self, *, skip_token: Optional[str] = None, **kwargs: Any) -> AsyncIterable[JSON]:
    ...
    @distributed_trace_async
    async def get_collection_path(self, collection_name: str, **kwargs: Any) -> JSON:
...
class ResourceSetRulesOperations:
    ...
    @distributed_trace_async
    async def get_resource_set_rule(self, **kwargs: Any) -> JSON:
    ...
    @distributed_trace_async
    async def create_or_update_resource_set_rule(
        self, resource_set_rule_config: Union[JSON, IO], **kwargs: Any
    ) -> JSON:
        """Creates or updates an resource set config.
    ...
    @distributed_trace_async
    async def delete_resource_set_rule(self, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
    ...
    @distributed_trace
    def list_resource_set_rules(self, *, skip_token: Optional[str] = None, **kwargs: Any) -> AsyncIterable[JSON]:
        """Get a resource set config service model.
