...
class OpenAIClientOperationsMixin(OpenAIClientMixinABC):
    ...
    async def _get_chat_completions_with_azure_extensions(
        self,
        deployment_id: str,
        body: _models.ChatCompletionsOptions,
        *,
    ...
    async def __get_azure_batch_image_generation_operation_status_initial(
    ...
    async def begin__get_azure_batch_image_generation_operation_status(  # pylint: disable=protected-access
        self, operation_id: str, **kwargs: Any
    ...
    async def __begin_azure_batch_image_generation_initial(
    ...
    async def begin__begin_azure_batch_image_generation(  # pylint: disable=protected-access
