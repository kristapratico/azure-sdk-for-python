...
|[sample_custom_classify_single_label.py][custom_classify_single_label_sample] and [sample_custom_classify_single_label_async.py][custom_classify_single_label_sample_async]|Use a custom model to classify documents into a single class|
|[sample_custom_classify_multi_label.py][custom_classify_multi_label_sample] and [sample_custom_classify_multi_label_async.py][custom_classify_multi_label_sample_async]|Use a custom model to classify documents into multiple classes|
