...
class ContentSource(msrest.serialization.Model):
    ...
    :type kind: str or ~azure.ai.formrecognizer.v3_0_preview_1.models.ContentSourceKind
    """
...
class BuildDocumentModelRequest(msrest.serialization.Model):
    ...
    :type technique: str or
     ~azure.ai.formrecognizer.v3_0_preview_1.models.DocumentModelBuildTechnique
    :param source: Required. Training data.
    :type source: ~azure.ai.formrecognizer.v3_0_preview_1.models.ContentSource
    """
...
class ComposeDocumentModelRequest(msrest.serialization.Model):
    ...
    :type component_models:
     list[~azure.ai.formrecognizer.v3_0_preview_1.models.ComposeDocumentModelRequestComponentModelsItem]
    """
    ...
    _attribute_map = {
        'model_id': {'key': 'modelId', 'type': 'str'},
        'description': {'key': 'description', 'type': 'str'},
        'component_models': {'key': 'componentModels', 'type': '[ComposeDocumentModelRequestComponentModelsItem]'},
    }
    ...
    def __init__(
        ...
        *,
        model_id: str,
        component_models: List["ComposeDocumentModelRequestComponentModelsItem"],
        description: Optional[str] = None,
        **kwargs
    ):
...
class ComposeDocumentModelRequestComponentModelsItem(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(ComposeDocumentModelRequestComponentModelsItem, self).__init__(**kwargs)
        self.model_id = model_id
...
class DocTypeInfo(msrest.serialization.Model):
    ...
    :param field_schema: Required. Description of the document semantic schema using a JSON Schema
     style syntax.
    :type field_schema: dict[str, ~azure.ai.formrecognizer.v3_0_preview_1.models.FieldTypeSchema]
...
class FieldTypeSchema(msrest.serialization.Model):
    ...
    :param type: Field type. Possible values include: "string", "date", "time", "phoneNumber",
     ...
     "object".
    :type type: str or ~azure.ai.formrecognizer.v3_0_preview_1.models.FieldTypeSchemaType
    :param description: Field description.
    :type description: str
    :param example: Example field content.
    :type example: str
    :param items: Field type schema of each array element.
    :type items: ~azure.ai.formrecognizer.v3_0_preview_1.models.FieldTypeSchema
    :param properties: Named sub-fields of the object field.
    :type properties: dict[str, ~azure.ai.formrecognizer.v3_0_preview_1.models.FieldTypeSchema]
    """
...
class GetInfoResponse(msrest.serialization.Model):
    ...
    :type custom_document_models:
     ~azure.ai.formrecognizer.v3_0_preview_1.models.GetInfoResponseCustomDocumentModels
    """
    ...
    _attribute_map = {
        'custom_document_models': {'key': 'customDocumentModels', 'type': 'GetInfoResponseCustomDocumentModels'},
    }

    def __init__(
        self,
        *,
        custom_document_models: "GetInfoResponseCustomDocumentModels",
        **kwargs
    ):
...
class GetInfoResponseCustomDocumentModels(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(GetInfoResponseCustomDocumentModels, self).__init__(**kwargs)
        self.count = count
        self.limit = limit
...
class OperationInfo(msrest.serialization.Model):
    ...
    :type kind: str or ~azure.ai.formrecognizer.v3_0_preview_1.models.OperationInfoKind
...
class GetOperationResponse(OperationInfo):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(GetOperationResponse, self).__init__(operation_id=operation_id, status=status, created_date_time=created_date_time, last_updated_date_time=last_updated_date_time, kind=kind, resource_location=resource_location, **kwargs)
        self.error = error
        self.result = result
