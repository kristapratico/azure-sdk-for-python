...
cog = ClientSecretCredential(
    client_id="863e8990-5159-4166-85bd-781b9551bb9e",
    secret="sU6KWT92WbpQN?g].6Z=UN=U9wl0J-ok",
...
def test_analyze_image():
    ...
    #         ],
    #     )
    print(resp.adult.is_adult_content)
...
# operations "broken off" from analyze_image ---------------------------------------------------------------------------
