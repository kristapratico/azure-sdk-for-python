...
class DocumentTranslationClient:
    ...
    :vartype document_translation:
     azure.ai.translation.document.aio.operations.DocumentTranslationOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.document_translation = DocumentTranslationOperations(self._client, self._config, self._serialize, self._deserialize)
