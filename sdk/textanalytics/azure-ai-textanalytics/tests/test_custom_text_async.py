...
from azure.ai.textanalytics.aio._lro_async import AsyncTextAnalyticsLROPoller
...
class TestCustomTextAsync(TextAnalyticsTest):
    ...
    @TextAnalyticsCustomPreparer()
    @recorded_by_proxy_async
    async def test_single_label_classification(
            self,
            textanalytics_custom_text_endpoint,
            textanalytics_custom_text_key,
        ...
        async with client:
            document_results = await (await client.begin_single_label_classification(
                docs,
    ...
    async def test_multi_label_classification(
        ...
        async with client:
            document_results = await (await client.begin_multi_label_classification(
                docs,
