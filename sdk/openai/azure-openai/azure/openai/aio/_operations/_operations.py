...
from ..._operations._operations import build_open_ai_begin_azure_batch_image_generation_request, build_open_ai_get_azure_batch_image_generation_operation_status_request, build_open_ai_get_chat_completions_request, build_open_ai_get_chat_completions_with_azure_extensions_request, build_open_ai_get_completions_request, build_open_ai_get_embeddings_request
...
class OpenAIClientOperationsMixin( 
    ...
    @overload
    async def _get_embeddings(  # pylint: disable=protected-access
        self,
        deployment_id: str,
    ...
    async def get_completions(
        self,
        deployment_id: str,
        body: Union[_models.CompletionsOptions, JSON, IO],
        **kwargs: Any
    ) -> _models.Completions:
        """Gets completions for the provided input prompts.
        Completions support a wide variety of tasks and generate text that continues from or
        ...
        content_type: Optional[str] = kwargs.pop('content_type', _headers.pop('Content-Type', None))
        cls: ClsType[_models.Completions] = kwargs.pop(
            'cls', None
        )
    ...
    async def get_chat_completions(
        self,
        deployment_id: str,
        body: Union[_models.ChatCompletionsOptions, JSON, IO],
        **kwargs: Any
    ) -> _models.ChatCompletions:
        """Gets chat completions for the provided chat messages.
        Completions support a wide variety of tasks and generate text that continues from or
        ...
        content_type: Optional[str] = kwargs.pop('content_type', _headers.pop('Content-Type', None))
        cls: ClsType[_models.ChatCompletions] = kwargs.pop(
            'cls', None
        )
    ...
    async def __get_azure_batch_image_generation_operation_status_initial(  # pylint: disable=name-too-long
        self,
        operation_id: str,
        **kwargs: Any
    ) -> JSON:
    ...
    async def begin__get_azure_batch_image_generation_operation_status(  # pylint: disable=protected-access,name-too-long
        self,
        operation_id: str,
        **kwargs: Any
    ) -> AsyncLROPoller[_models._models.BatchImageGenerationOperationResponse]:
        ...
        :return: An instance of AsyncLROPoller that returns BatchImageGenerationOperationResponse. The
         BatchImageGenerationOperationResponse is compatible with MutableMapping
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.openai.models.BatchImageGenerationOperationResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
        ...
        if cont_token is None:
            raw_result = await self.__get_azure_batch_image_generation_operation_status_initial(
                operation_id=operation_id,
                cls=lambda x,y,z: x,
                headers=_headers,
                params=_params,
    ...
    async def begin__begin_azure_batch_image_generation(  # pylint: disable=protected-access,name-too-long
        self,
        body: _models._models.ImageGenerationOptions,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[_models._models.BatchImageGenerationOperationResponse]:
