...
class TestChatCompletions(AzureRecordedTestCase):
    ...
    def test_chat_completion_max_tokens(self, client, azure_openai_creds, api_type):
        ...
        completion = client.chat.completions.create(model=model, messages=messages, max_tokens=50)
    ...
    def test_chat_completion_temperature(self, client, azure_openai_creds, api_type):
        ...
        completion = client.chat.completions.create(model=model, messages=messages, temperature=0.8)
    ...
    def test_chat_completion_top_p(self, client, azure_openai_creds, api_type):
        ...
        completion = client.chat.completions.create(model=model, messages=messages, top_p=0.1)
    ...
    def test_chat_completion_n(self, client, azure_openai_creds, api_type):
        ...
        completion = client.chat.completions.create(model=model, messages=messages, n=2)
    ...
    def test_chat_completion_stop(self, client, azure_openai_creds, api_type):
        ...
        completion = client.chat.completions.create(model=model, messages=messages, stop=" ")
