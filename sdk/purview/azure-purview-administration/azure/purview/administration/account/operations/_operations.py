...
def build_accounts_get_account_properties_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
...
def build_accounts_update_account_properties_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_accounts_get_access_keys_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_accounts_regenerate_access_key_request(**kwargs: Any) -> HttpRequest:  # pylint: disable=name-too-long
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_collections_get_collection_request(collection_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_collections_create_or_update_collection_request(  # pylint: disable=name-too-long
...
def build_collections_list_collections_request(  # pylint: disable=name-too-long
    *, skip_token: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_collections_list_child_collection_names_request(  # pylint: disable=name-too-long
    collection_name: str, *, skip_token: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_collections_get_collection_path_request(  # pylint: disable=name-too-long
    collection_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_resource_set_rules_get_resource_set_rule_request(  # pylint: disable=name-too-long
    **kwargs: Any,
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_resource_set_rules_create_or_update_resource_set_rule_request(  # pylint: disable=name-too-long
    **kwargs: Any,
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_resource_set_rules_delete_resource_set_rule_request(  # pylint: disable=name-too-long
    **kwargs: Any,
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_resource_set_rules_list_resource_set_rules_request(  # pylint: disable=name-too-long
    *, skip_token: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class AccountsOperations:
    ...
    @distributed_trace
    def get_account_properties(self, **kwargs: Any) -> JSON:
        """Get an account.
    ...
    def update_account_properties(
        self, account_update_parameters: JSON, *, content_type: str = "application/json", **kwargs: Any
    ) -> JSON:
        """Updates an account.
    ...
    @overload
    def update_account_properties(
        self, account_update_parameters: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> JSON:
        """Updates an account.
    ...
    @distributed_trace
    def update_account_properties(self, account_update_parameters: Union[JSON, IO], **kwargs: Any) -> JSON:
        """Updates an account.

        :param account_update_parameters: Is either a JSON type or a IO type. Required.
    ...
    @distributed_trace
    def get_access_keys(self, **kwargs: Any) -> JSON:
    ...
    def regenerate_access_key(
        self, key_options: JSON, *, content_type: str = "application/json", **kwargs: Any
    ) -> JSON:
    ...
    @overload
    def regenerate_access_key(self, key_options: IO, *, content_type: str = "application/json", **kwargs: Any) -> JSON:
        """Regenerate the authorization keys associated with this data catalog.
    ...
    @distributed_trace
    def regenerate_access_key(self, key_options: Union[JSON, IO], **kwargs: Any) -> JSON:
        """Regenerate the authorization keys associated with this data catalog.

        :param key_options: Is either a JSON type or a IO type. Required.
        ...
        _json = None
        _content = None
        if isinstance(key_options, (IOBase, bytes)):
...
class CollectionsOperations:
    ...
    @distributed_trace
    def get_collection(self, collection_name: str, **kwargs: Any) -> JSON:
        """Get a collection.
                ...
                response == {
                    ...
                    "parentCollection": {
                        ...
                        "type": "CollectionReference"  # Optional. Default value is
                          "CollectionReference". Gets or sets the reference type property.
                    },
                    "systemData": {
                        "createdAt": "2020-02-20 00:00:00",  # Optional. The timestamp of
                          resource creation (UTC).
    ...
    def create_or_update_collection(
        self, collection_name: str, collection: JSON, *, content_type: str = "application/json", **kwargs: Any
    ) -> JSON:
    ...
    @overload
    def create_or_update_collection(
        self, collection_name: str, collection: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> JSON:
        """Creates or updates a collection entity.
    ...
    @distributed_trace
    def create_or_update_collection(self, collection_name: str, collection: Union[JSON, IO], **kwargs: Any) -> JSON:
        """Creates or updates a collection entity.

        :param collection_name: Required.
        :type collection_name: str
        :param collection: Is either a JSON type or a IO type. Required.
        ...
        _json = None
        _content = None
        if isinstance(collection, (IOBase, bytes)):
            _content = collection
        else:
            _json = collection
    ...
    @distributed_trace
    def list_collections(self, *, skip_token: Optional[str] = None, **kwargs: Any) -> Iterable[JSON]:
    ...
    @distributed_trace
    def get_collection_path(self, collection_name: str, **kwargs: Any) -> JSON:
...
class ResourceSetRulesOperations:
    ...
    @distributed_trace
    def get_resource_set_rule(self, **kwargs: Any) -> JSON:
                        ...
                        "acceptedPatterns": [
                            {
                                ...
                                "modifiedBy": "AzureDataCatalog"  # Optional. Default
                                  value is "AzureDataCatalog". The configuration rules for path pattern
                                  extraction.
                            }
                        ],
    ...
    def create_or_update_resource_set_rule(
        self, resource_set_rule_config: JSON, *, content_type: str = "application/json", **kwargs: Any
    ) -> JSON:
    ...
    @overload
    def create_or_update_resource_set_rule(
        self, resource_set_rule_config: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> JSON:
        """Creates or updates an resource set config.
    ...
    @distributed_trace
    def create_or_update_resource_set_rule(self, resource_set_rule_config: Union[JSON, IO], **kwargs: Any) -> JSON:
        """Creates or updates an resource set config.

        :param resource_set_rule_config: Is either a JSON type or a IO type. Required.
        ...
        _json = None
        _content = None
        if isinstance(resource_set_rule_config, (IOBase, bytes)):
    ...
    @distributed_trace
    def delete_resource_set_rule(self, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
    ...
    @distributed_trace
    def list_resource_set_rules(self, *, skip_token: Optional[str] = None, **kwargs: Any) -> Iterable[JSON]:
        """Get a resource set config service model.
