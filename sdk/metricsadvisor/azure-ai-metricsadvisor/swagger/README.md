...
namespace: azure.ai.metricsadvisor._generated
output-folder: $(python-sdks-folder)/metricsadvisor/azure-ai-metricsadvisor/azure/ai/metricsadvisor/_generated/
```
