...
class AreaOfInterestResult(Model):
    ...
    :ivar area_of_interest: A bounding box for an area of interest inside an
     image.
    :vartype area_of_interest: ~computervision.models.BoundingRect
...
class ComputerVisionErrorException(HttpResponseError):
    ...
    def __init__(self, response, deserialize, *args):
      ...
      model_name = 'ComputerVisionError'
      self.error = deserialize(model_name, response)
      if self.error is None:
          self.error = deserialize.dependencies[model_name]()
      super(ComputerVisionErrorException, self).__init__(response=response)
...
class DetectResult(Model):
    ...
    :vartype objects: list[~computervision.models.DetectedObject]
    :param request_id: Id of the REST API request.
    :type request_id: str
    :param metadata:
    :type metadata: ~computervision.models.ImageMetadata
...
class ListModelsResult(Model):
    ...
    :vartype models_property: list[~computervision.models.ModelDescription]
    """
...
class OcrLine(Model):
    ...
    :param words: An array of objects, where each object represents a
     recognized word.
    :type words: list[~computervision.models.OcrWord]
    """
...
class OcrRegion(Model):
    ...
    :type lines: list[~computervision.models.OcrLine]
    """
...
class Line(Model):
    ...
    :type words: list[~ocr.models.Word]
    """
...
class ReadOperationResult(Model):
    ...
    :type status: str or ~ocr.models.TextOperationStatusCodes
    :param recognition_results: An array of text recognition result of the
     read operation.
    :type recognition_results: list[~ocr.models.TextRecognitionResult]
    """
...
class TextOperationResult(Model):
    ...
    :type recognition_result: ~ocr.models.TextRecognitionResult
    """
...
class Word(Model):
    ...
    :param confidence: Qualitative confidence measure. Possible values
     include: 'High', 'Low'
    :type confidence: str or ~ocr.models.TextRecognitionResultConfidenceClass
    """
