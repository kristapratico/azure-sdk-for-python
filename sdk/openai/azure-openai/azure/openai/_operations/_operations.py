...
from .._vendor import FileType, OpenAIClientMixinABC, prepare_multipart_form_data
from ._patch import Stream
...
def build_open_ai_generate_speech_from_text_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/deployments/{deploymentId}/audio/speech"
...
def build_open_ai_list_batches_request(
    *, after: Optional[str] = None, limit: Optional[int] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_open_ai_create_batch_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_open_ai_get_batch_request(batch_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})

    accept = _headers.pop("Accept", "application/json")

    # Construct URL
    _url = "/batches/{batchId}"
    path_format_arguments = {
...
def build_open_ai_cancel_batch_request(batch_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})

    accept = _headers.pop("Accept", "application/json")

    # Construct URL
    _url = "/batches/{batchId}/cancel"
    path_format_arguments = {
        "batchId": _SERIALIZER.url("batch_id", batch_id, "str"),
    }
...
def build_open_ai_get_image_generations_request(  # pylint: disable=name-too-long
    deployment_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/deployments/{deploymentId}/images/generations"
    path_format_arguments = {
        "deploymentId": _SERIALIZER.url("deployment_id", deployment_id, "str"),
    }
...
def build_open_ai_list_files_request(
...
def build_open_ai_create_upload_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_open_ai_add_upload_part_request(upload_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})

    accept = _headers.pop("Accept", "application/json")

    # Construct URL
    _url = "/uploads/{upload_id}/parts"
    path_format_arguments = {
        "upload_id": _SERIALIZER.url("upload_id", upload_id, "str"),
    }
...
def build_open_ai_complete_upload_request(upload_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = "/uploads/{upload_id}/complete"
    path_format_arguments = {
        "upload_id": _SERIALIZER.url("upload_id", upload_id, "str"),
    }
...
def build_open_ai_cancel_upload_request(upload_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})

    accept = _headers.pop("Accept", "application/json")

    # Construct URL
    _url = "/uploads/{upload_id}/cancel"
    path_format_arguments = {
        "upload_id": _SERIALIZER.url("upload_id", upload_id, "str"),
    }
...
class OpenAIClientOperationsMixin(OpenAIClientMixinABC):  # pylint: disable=too-many-public-methods
    ...
    @overload
    def get_audio_transcription_as_plain_text(self, deployment_id: str, body: JSON, **kwargs: Any) -> str:
        """Gets transcribed text and associated metadata from provided spoken audio data. Audio will be
        transcribed in the
        written language corresponding to the language it was spoken in.
    ...
    @overload
    def get_audio_translation_as_plain_text(self, deployment_id: str, body: JSON, **kwargs: Any) -> str:
        """Gets English language transcribed text and associated metadata from provided spoken audio data.
    ...
    def get_batch(self, batch_id: str, **kwargs: Any) -> _models.Batch:
    ...
    def cancel_batch(self, batch_id: str, **kwargs: Any) -> _models.Batch:
        """Gets details for a single batch specified by the given batchID.
    ...
    def get_chat_completions(
        ...
        def callback(model_json):
            deserialized = _deserialize(_models.ChatCompletions, model_json)
            if cls:
                return cls(pipeline_response, deserialized, {})
            return deserialized

        if _stream:
            return Stream[_models.ChatCompletions](
    ...
    @overload
    def add_upload_part(self, upload_id: str, request_body: JSON, **kwargs: Any) -> _models.UploadPart:
        """Adds a Part to an Upload object. A Part represents a chunk of bytes from the file you are
        trying to upload.
    ...
    def cancel_upload(self, upload_id: str, **kwargs: Any) -> _models.Upload:
